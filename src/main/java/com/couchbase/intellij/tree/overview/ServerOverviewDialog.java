...
public class ServerOverviewDialog extends DialogWrapper {
    ...
    private TitledSeparator getSeparator(String title) {
    ...
    public JPanel createKeyValuePanel(String[] keys, String[] values, int cols) {
    ...
    protected Action @NotNull [] createActions() {
        return new Action[]{getOKAction()};  // return only OK action
    }
}
