...
public class CouchbaseWindowContent extends JPanel {
    ...
    public CouchbaseWindowContent(Project project) {
        ...
        AnAction refreshAction = new AnAction() {
            @Override
        ...
        refreshAction.getTemplatePresentation().setIcon(IconLoader.findIcon("./assets/icons/new_query.svg", CouchbaseWindowContent.class, false, true));
        refreshAction.getTemplatePresentation().setDescription("Refresh");
        ...
        leftActionGroup.add(refreshAction);
