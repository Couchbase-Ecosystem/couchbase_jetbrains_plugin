...
public class OrderingClauseImpl extends SqlppPSIWrapper implements OrderingClause {

  public OrderingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public OrderOperator getOrderOperator() {
    return findChildByClass(OrderOperator.class);
  }
